...
function main(): void {
  ...
  // the mechanism behind the privacy claim: `default-src 'self'` with no
  // `connect-src` beyond self means the page CANNOT reach a foreign origin even
  // if something one day tried to.
  const headers = [
