...
export const QUALITY_SHARED_DEPENDENCIES = [
  ...
  // The register assembles from one file per module. Pinning only the barrel would cover none
  // of the entries it used to hold, so every part is a boundary, as the whole file was before.
  'src/platform/docs/limitations.ts',
  'src/platform/docs/limitations/types.ts',
  'src/platform/docs/limitations/anesthesia.ts',
  'src/platform/docs/limitations/emergency-medicine.ts',
  'src/platform/docs/limitations/critical-care.ts',
  'src/platform/docs/limitations/cardiology.ts',
  'src/platform/docs/limitations/respiratory-medicine.ts',
  'src/platform/docs/limitations/pediatrics.ts',
  'src/platform/docs/limitations/neurology.ts',
  'src/platform/docs/limitations/toxicology.ts',
  'src/platform/docs/limitations/obstetrics.ts',
  'src/platform/docs/limitations/neonatology.ts',
  'src/platform/docs/limitations/endocrine-metabolic.ts',
  'src/platform/docs/limitations/renal-electrolyte.ts',
