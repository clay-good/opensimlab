...
**opensimlab.com/anesthesia** is the first complete 39-scenario module. Emergency medicine is now playable at `/emergency-medicine`, beginning with 11 bounded labs spanning shock, tamponade, anaphylaxis, asthma, COPD, pulmonary edema, deteriorating pulmonary embolism, and STEMI inside the planned 25-case wave.
