...
**opensimlab.com/anesthesia** is the first complete 39-scenario module. Emergency medicine is complete at `/emergency-medicine` with 25 bounded labs. Critical care is now playable at `/critical-care` with 17 bounded labs, from ARDS ventilation through acute kidney injury with fluid overload, inside its planned 24-case wave.
