...
Pediatrics is now playable at `/pediatrics`, beginning with 1 of 16 bounded labs. Pediatric
respiratory distress teaches whole-child recognition and serial reassessment when saturation first
improves but work of breathing persists, then a falling respiratory rate signals fatigue rather than
recovery. It records experienced support, airway-capable rescue ownership, and active-risk handoff
without exposing diagnosis, oxygen-device, dosing, ventilation, airway, procedure, or treatment
controls.
