...
The fourth lab moves severe-hypertension practice into a distinct postpartum setting. Six days
after a normotensive pregnancy and completed birth, 2 correctly obtained severe-range pressures,
headache, visual symptoms, upper-abdominal pain and supplied organ findings trigger immediate
protocol activation without waiting for urine protein; evaluation continues in parallel. A fixed
later report remains hypertensive and symptomatic. No learner pressure measurement, test
...
one strict, version-bound record registry. Hypocalcemia, post-rescue hyponatremia, and AVP-deficiency
dehydration each supply training-value, authored-defaults, and hazard records; their state-space
matrices remain missing.
