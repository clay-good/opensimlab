...
244 bounded labs across 16 specialties:
...
| Surgery and trauma | 4 | `/surgery-trauma` |

Counts are the registered scenarios the build audits, not a roadmap. Every module above is at its
full planned count except surgery and trauma, which has four labs of a planned ten. Nothing is
...
anesthesia, and surgery and trauma, whose four labs are the newest.
