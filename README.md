...
**opensimlab.com/anesthesia** is the first complete 39-scenario module. Emergency medicine is now playable at `/emergency-medicine`, beginning with 15 bounded labs spanning shock, tamponade, anaphylaxis, asthma, COPD, pulmonary edema, pulmonary embolism, STEMI, unstable rhythms, and both shockable and nonshockable arrest inside the planned 25-case wave.
