...
**opensimlab.com/anesthesia** is the first complete 39-scenario module. Emergency medicine is now playable at `/emergency-medicine`, beginning with 12 bounded labs spanning shock, tamponade, anaphylaxis, asthma, COPD, pulmonary edema, pulmonary embolism, STEMI, and unstable tachycardia inside the planned 25-case wave.
