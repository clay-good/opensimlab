...
**opensimlab.com/anesthesia** is the first complete 39-scenario module. Emergency medicine is now playable at `/emergency-medicine`, beginning with 10 bounded labs spanning shock, tamponade, anaphylaxis, asthma, COPD, acute pulmonary edema, and deteriorating pulmonary embolism inside the planned 25-case wave.
