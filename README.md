...
**opensimlab.com/anesthesia** is the first complete 39-scenario module. Emergency medicine is complete at `/emergency-medicine` with 25 bounded labs. Critical care is now playable at `/critical-care` with ARDS lung-protective ventilation and escalating-hypoxemia labs inside its planned 24-case wave.
