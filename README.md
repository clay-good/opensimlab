...
**opensimlab.com/anesthesia** is the first complete 39-scenario module. Emergency medicine is complete at `/emergency-medicine` with 25 bounded labs. Critical care is complete at `/critical-care` with 24 bounded labs. Cardiology is now playable at `/cardiology` with bounded stable chest-pain, acute coronary, heart-failure, post-infarction shock-escalation, atrial-fibrillation, tachycardia, sinus-bradycardia, complete-heart-block, torsades, hyperkalemic-conduction, pericardial-tamponade, and right-ventricular-infarction labs.
