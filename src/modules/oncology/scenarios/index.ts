...
export const ONCOLOGY_SCENARIOS: readonly Scenario[] = [DELAYED_IMMUNE_EVENT_A_DRUG_THAT_STOPPED_MONTHS_AGO, INCIDENTAL_CLOT_A_DECISION_THE_EVIDENCE_CANNOT_MAKE, NORMAL_TEST_TOXICITY_THE_DOSE_IN_HIS_BAG, PROGNOSIS_QUESTION_A_NUMBER_HE_ASKED_FOR, LABORATORY_TLS_A_SYNDROME_HE_DOES_NOT_HAVE_YET, RARE_EARLY_MYOCARDITIS_A_BASE_RATE_IS_NOT_A_THRESHOLD, LOWERING_THE_COUNT_A_NUMBER_THAT_CAN_BE_MOVED];
