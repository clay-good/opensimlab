...
export const EXPLAINERS: readonly Explainer[] = [
  ...
  },
  {
    ...
    body:
      ...
      + 'Benumof and colleagues measured it. A healthy 70 kg adult has roughly eight minutes to a '
      + 'saturation of 90%. A moderately ill adult has about five. An obese adult has under three, '
      + 'because their functional residual capacity is small and their oxygen consumption is high.\n\n'
      + 'Without preoxygenation, the same healthy adult has under a minute.\n\n'
