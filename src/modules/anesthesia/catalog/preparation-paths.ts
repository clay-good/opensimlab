...
export const PREPARATION_PATHS: readonly PreparationPathDefinition[] = [
  ...
  {
    id: 'ventilation-respiratory-failure', version: '0.1.0', title: 'Ventilation and respiratory failure',
    description: 'Use saturation, capnography, and airway state together rather than chasing one number.',
    scenarioIds: ['rapid-desaturation', 'bronchospasm', 'laryngospasm-after-airway-stimulation', 'venous-air-embolism-during-line-removal'],
    prerequisites: ['Basic monitor orientation.'],
  ...
  {
    id: 'handoff-escalation', version: '0.1.0', title: 'Handoff and escalation',
    description: 'Practice recognizing when the simulated problem exceeds solo management and help is part of the response.',
    scenarioIds: ['unexpected-intraoperative-hemorrhage', 'bronchospasm', 'perioperative-anaphylaxis-after-antibiotic', 'early-malignant-hyperthermia-during-volatile-anesthesia', 'venous-air-embolism-during-line-removal'],
    prerequisites: ['Basic monitor orientation.'],
