...
import { pediatricSvtCompletionEvidence } from '../../pediatrics/pediatric-svt-completion';
import { pediatricBradycardicArrestCompletionEvidence } from '../../pediatrics/pediatric-bradycardic-arrest-completion';
import { pediatricFbaoCompletionEvidence } from '../../pediatrics/pediatric-fbao-completion';
import { pediatricInjurySafeguardingCompletionEvidence } from '../../pediatrics/pediatric-injury-safeguarding-completion';
...
import { transcutaneousPacingCaptureCompletionEvidence } from '../../cardiology/transcutaneous-pacing-capture-completion';
import { septicShockResuscitationCompletionEvidence } from '../../critical-care/septic-shock-resuscitation-completion';
...
import { hypotensionAfterInductionCompletionEvidence } from '../hypotension-after-induction-completion';
...
import { routinePediatricInhalationalInductionCompletionEvidence } from '../routine-pediatric-inhalational-induction-completion';
...
import { statusEpilepticusCompletionEvidence } from '../../emergency-medicine/status-epilepticus-completion';
import { septicShockEmergencyCompletionEvidence } from '../../emergency-medicine/septic-shock-completion';
...
export function auditClinicalScenario(
  ...
  const exactEvidence = new Map([
    ...
    ...pediatricSvtCompletionEvidence(scenario, capabilityVersion, moduleId),
    ...pediatricBradycardicArrestCompletionEvidence(scenario, capabilityVersion, moduleId),
    ...pediatricFbaoCompletionEvidence(scenario, capabilityVersion, moduleId),
    ...pediatricInjurySafeguardingCompletionEvidence(scenario, capabilityVersion, moduleId),
    ...
    ...transcutaneousPacingCaptureCompletionEvidence(scenario, capabilityVersion, moduleId),
    ...septicShockResuscitationCompletionEvidence(scenario, capabilityVersion, moduleId),
    ...
    ...hypotensionAfterInductionCompletionEvidence(scenario, capabilityVersion, moduleId),
    ...
    ...routinePediatricInhalationalInductionCompletionEvidence(scenario, capabilityVersion, moduleId),
    ...
    ...statusEpilepticusCompletionEvidence(scenario, capabilityVersion, moduleId),
    ...septicShockEmergencyCompletionEvidence(scenario, capabilityVersion, moduleId),
