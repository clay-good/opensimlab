...
export interface ActionCockpitProps {
  ...
  readonly onSpontaneousBreathingTrialResponse?: (
  ...
  readonly onSymptomaticBradycardiaResponse?: (
    action: 'reconcile-symptomatic-bradycardia-stability'
  ...
  readonly onNoninvasiveVentilationSelectionResponse?: (
    action: 'reconcile-noninvasive-ventilation-selection-treatment-and-trajectory'
  ...
  readonly onPediatricHypoglycemicSeizureResponse?: (
    action: 'reconcile-pediatric-hypoglycemic-seizure-whole-child-and-glucose'
  ...
  readonly onPediatricStatusEpilepticusResponse?: (
    action: 'reconcile-pediatric-status-epilepticus-clock-care-and-whole-child'
  ...
  readonly onPediatricSupraventricularTachycardiaResponse?: (
    action: 'reconcile-pediatric-svt-clock-rhythm-and-whole-child'
  ...
  readonly onNeurologyGbsResponse?: (
    action: 'reconcile-neurology-gbs-clock-ascending-weakness-bulbar-respiratory-autonomic-and-whole-patient'
  ...
  readonly onNeurologyHerniationResponse?: (
    action: 'reconcile-neurology-herniation-clock-consciousness-pupils-motor-physiology-and-whole-patient'
  ...
  readonly onObstetricsPostpartumPreeclampsiaResponse?: (
    action: 'reconcile-obstetrics-postpartum-preeclampsia-clock-symptoms-pressure-organs-newborn-and-whole-person'
  ...
  readonly onObstetricsAfeResponse?: (
    action: 'activate-obstetrics-afe-coordinated-obstetric-anesthesia-critical-care-cardiopulmonary-hemorrhage-newborn-and-dignity-response'
...
export function crisisResponseAvailability(
  ...
  return {
    ...
    hasSymptomaticBradycardiaResponse: scenario.timeline.some(
      (event) => event.type === 'narrative'
    ...
    hasNoninvasiveVentilationSelectionResponse: scenario.timeline.some(
      (event) => event.type === 'narrative'
    ...
    hasPediatricSupraventricularTachycardiaResponse:
      scenario.metadata.id === 'pediatric-supraventricular-tachycardia'
      && scenario.timeline.some((event) => event.type === 'narrative'
    ...
    hasNeurologyGbsResponse:
      scenario.metadata.id === 'guillain-barre-respiratory-decline'
      && scenario.timeline.some((event) => event.type === 'narrative'
    ...
    hasNeurologyHerniationResponse:
      scenario.metadata.id === 'acute-transtentorial-herniation-pattern'
      && scenario.timeline.some((event) => event.type === 'narrative'
...
export function ActionCockpit(props: ActionCockpitProps) {
  ...
  const responseTray = hasAdrenalCrisisResponse
...
function NeurologyGbsTray({ assessment, onAction }: {
  assessment?: NonNullable<ActionCockpitProps['resuscitation']['neurologyGbsAssessment']>;
  onAction: NonNullable<ActionCockpitProps['onNeurologyGbsResponse']>;
}) {
  const trajectory = assessment?.trajectoryAtTick != null;
  const evidence = assessment?.evidenceAtTick != null;
  const recognition = assessment?.recognitionAtTick != null;
  ...
  return <div className="tray-grid">
    <section className="syringe" aria-labelledby="neurology-gbs-pattern-title">
      ...
      <div className="syringe__presets">
        {!trajectory && <Button className="crisis-drug__action" onClick={() => onAction('reconcile-neurology-gbs-clock-ascending-weakness-bulbar-respiratory-autonomic-and-whole-patient')}>Review ascending trajectory</Button>}
        {trajectory && !evidence && <Button className="crisis-drug__action" onClick={() => onAction('review-neurology-gbs-supportive-evidence-mimics-and-diagnostic-boundary')}>Review evidence + mimics</Button>}
        {evidence && !recognition && <Button className="crisis-drug__action" onClick={() => onAction('recognize-neurology-gbs-high-risk-respiratory-decline-without-score-or-single-cutoff')}>Recognize respiratory risk</Button>}
        {recognition && !ownership && <Button className="crisis-drug__action" onClick={() => onAction('activate-neurology-gbs-qualified-neurocritical-respiratory-airway-and-cardiac-ownership')}>Activate airway + cardiac owners</Button>}
      </div>
    ...
    <section className="syringe" aria-labelledby="neurology-gbs-later-title">
      ...
      <div className="syringe__presets">
        {ownership && !later && <Button className="crisis-drug__action" onClick={() => onAction('review-neurology-gbs-strict-later-respiratory-bulbar-and-autonomic-trajectory')}>Review the 4-hour decline</Button>}
...
function ObstetricsCordProlapseTray({ assessment, onAction }: {
  ...
  return <>
    <section className="syringe" aria-labelledby="obstetrics-cord-prolapse-now-title">
      ...
      <div className="crisis-drug__actions">
        {!support && <Button className="crisis-drug__action" onClick={() => onAction('activate-obstetrics-cord-prolapse-response-diagnosis-clock-theatre-anesthesia-newborn-and-support-roles')}>Activate response + diagnosis clock</Button>}
        {support && !context && <Button className="crisis-drug__action" onClick={() => onAction('reconcile-obstetrics-cord-prolapse-membrane-rupture-fetal-heart-exam-birth-imminence-and-whole-person')}>Connect rupture + whole-person facts</Button>}
        {context && !bridge && <Button className="crisis-drug__action" onClick={() => onAction('review-obstetrics-cord-prolapse-pressure-relief-minimal-handling-position-and-no-delay-boundaries')}>Review temporary-bridge boundaries</Button>}
        {bridge && !birthPlan && <Button className="crisis-drug__action" onClick={() => onAction('review-obstetrics-cord-prolapse-birth-urgency-mode-anesthesia-newborn-documentation-and-safety-boundaries')}>Review urgent-birth coordination</Button>}
      </div>
    </section>
...
function NeonatologyApneaTray({ assessment, onAction }: {
  ...
  return <>
    <section className="syringe" aria-labelledby="neonatology-apnea-now-title">
      ...
      <div className="crisis-drug__actions">
        {!support && <Button className="crisis-drug__action" onClick={() => onAction('activate-neonatal-apnea-qualified-newborn-airway-clock-and-dyad-support')}>Activate qualified response</Button>}
        {support && !context && <Button className="crisis-drug__action" onClick={() => onAction('reconcile-neonatal-apnea-gestation-birth-clock-breathing-heart-rate-tone-temperature-and-whole-dyad')}>Connect newborn + whole dyad</Button>}
        {context && !recognition && <Button className="crisis-drug__action" onClick={() => onAction('recognize-neonatal-apnea-ventilation-threshold-without-cause-or-outcome-closure')}>Recognize the threshold</Button>}
        {recognition && !readiness && <Button className="crisis-drug__action" onClick={() => onAction('review-neonatal-apnea-qualified-effective-ventilation-heart-rate-and-escalation-readiness')}>Review qualified response</Button>}
      </div>
    </section>
...
function NeonatologyBradycardiaTray({ assessment, onAction }: {
  ...
  return <>
    <section className="syringe" aria-labelledby="neonatology-bradycardia-now-title">
      ...
      <div className="crisis-drug__actions">
        {!support && <Button className="crisis-drug__action" onClick={() => onAction('activate-neonatal-bradycardia-qualified-compression-ventilation-clock-and-dyad-response')}>Activate qualified response</Button>}
        {support && !context && <Button className="crisis-drug__action" onClick={() => onAction('reconcile-neonatal-bradycardia-adequate-ventilation-heart-rate-airway-oxygenation-and-whole-dyad')}>Connect trajectory + whole dyad</Button>}
        {context && !recognition && <Button className="crisis-drug__action" onClick={() => onAction('recognize-neonatal-bradycardia-compression-threshold-after-adequate-ventilation')}>Recognize the threshold</Button>}
        {recognition && !readiness && <Button className="crisis-drug__action" onClick={() => onAction('review-qualified-neonatal-compression-ventilation-coordination-and-epinephrine-boundary')}>Review later-branch boundaries</Button>}
      </div>
    </section>
