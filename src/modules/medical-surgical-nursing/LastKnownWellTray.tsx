  ...
  return <>
    ...
    <section className="syringe last-known-well__section" aria-labelledby="last-known-well-activation-title">
      ...
      <p className="syringe__remaining">{assessment.boundariesReviewedAtTick === null
        ...
        : 'Supplied boundaries: last known well is a bound and should never be charted as an onset. An unknown time is a reason to escalate for assessment rather than to stand down: a randomised trial enrolled this population and found a higher rate of favourable outcome in the treated group, with eligibility assessed by imaging as a surrogate for lesion age rather than by a remembered time. That describes a population and a pathway, not this patient, and the eligibility decision is not the ward’s to make.'}</p>
