...
export const LAST_KNOWN_WELL_A_TIME_NOBODY_CAN_SUPPLY: Scenario = {
  schemaVersion: 1,
  metadata: {
    id: 'last-known-well-a-time-nobody-can-supply', version: '0.1.1', maturity: 'preview',
