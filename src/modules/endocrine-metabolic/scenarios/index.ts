...
export const ENDOCRINE_METABOLIC_SCENARIOS: readonly Scenario[] = [DKA_RESOLUTION_TRANSITION, HHS_OSMOLALITY_TRAJECTORY, SEVERE_HYPOGLYCEMIA_RECURRENCE, ADRENAL_CRISIS_TREATMENT_BEFORE_TESTS, THYROID_STORM_HEMODYNAMIC_RISK, MYXEDEMA_COMA_VENTILATION_AND_STEROID_SEQUENCE, HYPERCALCEMIC_CRISIS_VOLUME_AND_BRIDGE, HYPOCALCEMIC_TETANY_RESCUE_AND_RECURRENCE];
