...
export function NecrotizingInfectionTray({ assessment, onAction, demonstrating = false }: {
  ...
  return <>
    ...
    <section className="syringe necrotizing-infection__section" aria-labelledby="necrotizing-infection-recognition-title">
      ...
      <p className="syringe__remaining">Supplied laboratory evidence: white cells 14.8 x10^9/L, C-reactive protein 132 mg/L, sodium 136 mmol/L, creatinine 118 µmol/L, glucose 11.4 mmol/L, haemoglobin 12.6 g/dL, lactate 2.4 mmol/L. Derived risk score 3, below its usual cutoff of 6. Pooled sensitivity at that cutoff is near two-thirds, so roughly one confirmed case in three scores below it.</p>
