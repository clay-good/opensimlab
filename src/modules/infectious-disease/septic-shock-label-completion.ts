...
export function septicShockLabelCompletionEvidence(scenario: Scenario, capabilityVersion: string, moduleId: string): readonly CompletionRequirementAudit[] {
  ...
  return [
    ...
    { id: 'reference-transcripts', status: 'satisfied', evidence: ['septic-shock-fixtures.ts binds exact-content expert, common-error, recovery, and no-action pathways for deterministic replay through the shared engine.'] },
