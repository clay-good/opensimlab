...
export const INFECTIOUS_DISEASE_SCENARIOS: readonly Scenario[] = [MENINGOCOCCAL_SEPSIS_RECOGNITION_AND_ESCALATION, OBSTRUCTED_INFECTED_KIDNEY_DECOMPRESSION, FEBRILE_NEUTROPENIA_BLIND_EXAMINATION, NECROTIZING_INFECTION_SCORE_CANNOT_EXCLUDE, ENDOCARDITIS_MECHANICAL_FAILURE_ON_A_SURGICAL_CLOCK, SEVERE_PNEUMONIA_THE_SCORE_ANSWERED_ANOTHER_QUESTION, TOXIC_SHOCK_A_DEFINITION_THAT_CANNOT_CLOSE];
