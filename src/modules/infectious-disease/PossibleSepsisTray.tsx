...
import { possibleSepsisInlinePrompt } from './possible-sepsis-tutor';

export function PossibleSepsisTray({ assessment, scenarioVersion, onAction, guidance = 'unassisted', demonstrating = false }: {
  ...
  const prompt = possibleSepsisInlinePrompt(guidance, { scenarioVersion, possibleSepsis: assessment });
