...
import { RENAL_ESTIMATED_FILTRATION } from './estimated-filtration-a-number-she-was-never-measured-by';
import { RENAL_PHOSPHATE_TARGET } from './phosphate-target-a-surrogate-that-moved-the-wrong-way';
import { RENAL_PROTEINURIA_RATIO } from './proteinuria-a-ratio-that-doubled-and-a-patient-who-did-not';

export const RENAL_ELECTROLYTE_SCENARIOS: readonly Scenario[] = [RENAL_HYPERKALEMIA_CARDIOPROTECTION_AND_REBOUND, RENAL_HYPOKALEMIA_MAGNESIUM_AND_ONGOING_LOSSES, RENAL_HYPONATREMIA_SYMPTOMS_AND_REASSESSMENT, RENAL_HYPERNATREMIA_WATER_ACCESS_AND_LOSSES, RENAL_HYPOCALCEMIA_IONIZED_CALCIUM_AND_CKD, RENAL_HYPERMAGNESEMIA_ANTAGONISM_AND_REMOVAL, RENAL_HYPOMAGNESEMIA_REFRACTORY_POTASSIUM, RENAL_CONTRAST_ATTRIBUTION_LABEL, RENAL_RHABDOMYOLYSIS_NUMBER, RENAL_ESTIMATED_FILTRATION, RENAL_PHOSPHATE_TARGET, RENAL_PROTEINURIA_RATIO];
