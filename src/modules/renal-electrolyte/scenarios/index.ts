...
export const RENAL_ELECTROLYTE_SCENARIOS: readonly Scenario[] = [RENAL_HYPERKALEMIA_CARDIOPROTECTION_AND_REBOUND, RENAL_HYPOKALEMIA_MAGNESIUM_AND_ONGOING_LOSSES, RENAL_HYPONATREMIA_SYMPTOMS_AND_REASSESSMENT, RENAL_HYPERNATREMIA_WATER_ACCESS_AND_LOSSES, RENAL_HYPOCALCEMIA_IONIZED_CALCIUM_AND_CKD, RENAL_HYPERMAGNESEMIA_ANTAGONISM_AND_REMOVAL];
