...
import { RenalPhosphateTargetTray } from './RenalPhosphateTargetTray';
import { RenalProteinuriaRatioTray } from './RenalProteinuriaRatioTray';
...
import { supportsRenalPhosphateTarget } from './phosphate-target';
import { supportsRenalProteinuriaRatio } from './proteinuria-ratio';
...
export const RENAL_ELECTROLYTE_TRAYS: readonly LessonTray[] = [
  ...
  { id: 'RenalProteinuriaRatio', actionType: 'renal-proteinuria-ratio-response', supports: supportsRenalProteinuriaRatio, assessment: (r) => r?.renalProteinuriaRatio, opensSource: true, Component: RenalProteinuriaRatioTray as LessonTray['Component'] },
  { id: 'RenalPhosphateTarget', actionType: 'renal-phosphate-target-response', supports: supportsRenalPhosphateTarget, assessment: (r) => r?.renalPhosphateTarget, opensSource: true, Component: RenalPhosphateTargetTray as LessonTray['Component'] },
