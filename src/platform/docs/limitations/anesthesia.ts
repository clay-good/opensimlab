/**
 * The anesthesia module's limitations.
 *
 * Split out of the single register so a module's cockpit chunk carries its own entries and not the
 * other fourteen modules'. An entry is filed here if a anesthesia scenario names it through `briefIn`
...
export const ANESTHESIA_LIMITATIONS: readonly Limitation[] = [
  {
