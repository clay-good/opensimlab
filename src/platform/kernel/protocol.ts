...
export interface RenalHypomagnesemiaSnapshot {
  readonly supportActive: boolean;
  readonly monitoringAtTick: number | null;
  readonly stopExposureAtTick: number | null;
  readonly contextReviewedAtTick: number | null;
  readonly repletionAtTick: number | null;
  readonly numberReviewedAtTick: number | null;
  readonly repletionDueInSeconds: number | null;
  readonly repletionResponseObserved: boolean;
  readonly untreatedContrastObserved: boolean;
  readonly potassiumAloneAttempted: boolean;
  readonly normalNumberClaimAttempted: boolean;
  readonly magnesiumObservation: { readonly atTick: number; readonly magnesiumMmolL: number } | null;
  readonly potassiumObservation: { readonly atTick: number; readonly potassiumMmolL: number } | null;
  readonly observation: {
    readonly atTick: number; readonly magnesiumMmolL: number; readonly potassiumMmolL: number;
    readonly ionizedCalciumMmolL: number; readonly qtcMs: number; readonly crampingPresent: boolean;
    readonly heartRateBpm: number; readonly systolicMmHg: number; readonly diastolicMmHg: number;
    readonly meanArterialMmHg: number; readonly respiratoryRateBpm: number; readonly spo2Percent: number;
    readonly coreTemperatureC: number; readonly alertness: string;
  } | null;
...
export interface RenalRhabdomyolysisSnapshot {
  readonly supportActive: boolean;
  readonly causeReviewedAtTick: number | null;
  readonly compartmentExaminedAtTick: number | null;
  readonly numberReviewedAtTick: number | null;
  readonly additionsReviewedAtTick: number | null;
  readonly fluidsArrangedAtTick: number | null;
  readonly monitoringAtTick: number | null;
  readonly serialDueInSeconds: number | null;
  readonly serialOpened: boolean;
  readonly unexaminedContrastObserved: boolean;
  readonly dialysisOnNumberAttempted: boolean;
  readonly additionsAttempted: boolean;
  readonly creatineKinaseObservation: { readonly atTick: number; readonly creatineKinaseUL: number } | null;
  readonly renalObservation: { readonly atTick: number; readonly creatinineUmolL: number; readonly urineMlPerKgPerHour: number } | null;
  readonly observation: {
    readonly atTick: number; readonly creatineKinaseUL: number; readonly creatinineUmolL: number;
    readonly urineMlPerKgPerHour: number; readonly potassiumMmolL: number; readonly compartmentConcern: boolean;
    readonly heartRateBpm: number; readonly systolicMmHg: number; readonly diastolicMmHg: number;
    readonly meanArterialMmHg: number; readonly respiratoryRateBpm: number; readonly spo2Percent: number;
    readonly coreTemperatureC: number; readonly alertness: string;
  } | null;
...
export interface RenalPhosphateTargetSnapshot {
  readonly supportActive: boolean;
  readonly surrogateReviewedAtTick: number | null;
  readonly trialReviewedAtTick: number | null;
  readonly intakeReviewedAtTick: number | null;
  readonly decisionOwnedAtTick: number | null;
  readonly monitoringAtTick: number | null;
  readonly recordsDueInSeconds: number | null;
  readonly recordsOpened: boolean;
  readonly unexaminedContrastObserved: boolean;
  readonly treatTheNumberAttempted: boolean;
  readonly restrictFurtherAttempted: boolean;
  readonly phosphateObservation: { readonly atTick: number; readonly phosphateMmolL: number } | null;
  readonly nutritionObservation: { readonly atTick: number; readonly weightKg: number; readonly albuminGL: number } | null;
  readonly observation: {
    readonly atTick: number; readonly phosphateMmolL: number; readonly weightKg: number;
    readonly albuminGL: number; readonly parathyroidPmolL: number; readonly restrictionsApplied: number;
    readonly heartRateBpm: number; readonly systolicMmHg: number; readonly diastolicMmHg: number;
    readonly meanArterialMmHg: number; readonly respiratoryRateBpm: number; readonly spo2Percent: number;
    readonly coreTemperatureC: number; readonly alertness: string;
  } | null;
...
export interface SilentInteractionSnapshot {
  readonly reconciledAtTick: number | null;
  readonly directionRecordedAtTick: number | null;
  readonly escalationAtTick: number | null;
  readonly treatmentIntentAtTick: number | null;
  readonly boundariesReviewedAtTick: number | null;
  readonly overlapWeeks: number;
  readonly anyAbnormalFinding: boolean;
  readonly pharmacyRecordArrived: boolean;
  readonly teamResponded: boolean;
  readonly teamObserved: boolean;
  readonly stopInstructionAttempted: boolean;
  readonly nothingToDoAttempted: boolean;
  readonly theoreticalAttempted: boolean;
  readonly notesOnlyAttempted: boolean;
  readonly observationRecord: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
    readonly symptomAccount: string;
  } | null;
  readonly recordCheck: {
    readonly atTick: number; readonly clinicListItems: number; readonly practiceListItems: number;
    readonly pharmacyListAvailable: boolean; readonly pharmacyListItems: number;
    readonly overlapWeeks: number;
  } | null;
  readonly observation: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
    readonly symptomAccount: string; readonly clinicListItems: number;
    readonly practiceListItems: number; readonly pharmacyListAvailable: boolean;
    readonly pharmacyListItems: number; readonly overlapWeeks: number;
    readonly alertness: string;
  } | null;
  readonly alertness: string;
  readonly choiceFeedback: string | null;
...
export interface TrialRuleSnapshot {
  readonly trajectoryRecordedAtTick: number | null;
  readonly governanceRecordedAtTick: number | null;
  readonly escalationAtTick: number | null;
  readonly treatmentIntentAtTick: number | null;
  readonly boundariesReviewedAtTick: number | null;
  readonly pseudoprogressionCeilingPercent: number;
  readonly clinicallyStable: boolean;
  readonly documentRead: boolean;
  readonly teamResponded: boolean;
  readonly teamObserved: boolean;
  readonly continueAttempted: boolean;
  readonly stopAttempted: boolean;
  readonly scanOnlyAttempted: boolean;
  readonly waitAttempted: boolean;
  readonly observationRecord: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
    readonly weightChangeKg: number; readonly trajectoryWeeks: number;
    readonly functionalAccount: string;
  } | null;
  readonly imagingRecord: {
    readonly atTick: number; readonly weeksOnTreatment: number; readonly reportAgeDays: number;
    readonly newLesions: boolean; readonly clinicallyStable: boolean;
  } | null;
  readonly observation: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
    readonly weightChangeKg: number; readonly trajectoryWeeks: number;
    readonly functionalAccount: string; readonly weeksOnTreatment: number;
    readonly reportAgeDays: number; readonly newLesions: boolean;
    readonly clinicallyStable: boolean; readonly alertness: string;
  } | null;
  readonly alertness: string;
  readonly choiceFeedback: string | null;
  readonly ended: 'handoff' | 'instructor-takeover' | null;
...
export interface LaboratoryTlsSnapshot {
  readonly definitionRecordedAtTick: number | null;
  readonly crossingRecordedAtTick: number | null;
  readonly riskRecordedAtTick: number | null;
  readonly escalationAtTick: number | null;
  readonly treatmentIntentAtTick: number | null;
  readonly boundariesReviewedAtTick: number | null;
  readonly hoursAfterTreatment: number;
  readonly laboratoryCriteriaMet: boolean;
  readonly clinicalCriteriaMet: boolean;
  readonly repeatReturned: boolean;
  readonly teamResponded: boolean;
  readonly teamObserved: boolean;
  readonly dismissalAttempted: boolean;
  readonly overcallAttempted: boolean;
  readonly waitForNextSetAttempted: boolean;
  readonly standDownAttempted: boolean;
  readonly observationRecord: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
    readonly rhythm: string; readonly urineOutput: string;
  } | null;
  readonly bloodRecord: {
    readonly atTick: number; readonly hoursAfterTreatment: number; readonly risingSet: boolean;
    readonly creatinineUnchanged: boolean; readonly laboratoryCriteriaMet: boolean;
    readonly clinicalCriteriaMet: boolean;
  } | null;
  readonly observation: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    ...
    readonly spo2Percent: number; readonly coreTemperatureC: number;
    readonly rhythm: string; readonly urineOutput: string;
    readonly hoursAfterTreatment: number; readonly risingSet: boolean;
    readonly creatinineUnchanged: boolean; readonly laboratoryCriteriaMet: boolean;
    readonly clinicalCriteriaMet: boolean; readonly alertness: string;
  } | null;
  readonly alertness: string;
  readonly choiceFeedback: string | null;
  readonly ended: 'handoff' | 'instructor-takeover' | null;
...
export interface DelayedImmuneEventSnapshot {
  readonly exposureRecordedAtTick: number | null;
  readonly courseRecordedAtTick: number | null;
  readonly infectionEvaluationAtTick: number | null;
  readonly escalationAtTick: number | null;
  readonly treatmentIntentAtTick: number | null;
  readonly boundariesReviewedAtTick: number | null;
  readonly weeksSinceLastDose: number;
  readonly checkpointInhibitorCycles: number;
  readonly absentFromCurrentMedicationList: boolean;
  readonly stoolsToday: number;
  readonly courseProgressed: boolean;
  readonly serviceResponded: boolean;
  readonly serviceObserved: boolean;
  readonly attributionExclusionAttempted: boolean;
  readonly motilityAttempted: boolean;
  readonly waitForResultsAttempted: boolean;
  readonly dischargeAttempted: boolean;
  readonly observationRecord: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number; readonly stoolsToday: number;
  ...
  readonly exposureRecord: {
    readonly atTick: number; readonly checkpointInhibitorCycles: number;
    readonly weeksSinceLastDose: number; readonly onCurrentMedicationList: boolean;
    readonly referralAttribution: string;
  } | null;
  readonly observation: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
...
export interface UnfinishedSurveySnapshot {
  readonly examinationLimitsRecordedAtTick: number | null;
  readonly injuryListRecordedAtTick: number | null;
  readonly surveyIncompleteRecordedAtTick: number | null;
  readonly escalationAtTick: number | null;
  readonly surveyIntentAtTick: number | null;
  readonly boundariesReviewedAtTick: number | null;
  readonly hoursSinceInjury: number;
  readonly listedInjuries: number;
  readonly secondarySurveyDocumented: boolean;
  readonly tertiarySurveyDocumented: boolean;
  readonly sedationLightened: boolean;
  readonly teamResponded: boolean;
  readonly teamObserved: boolean;
  readonly documentationClaimAttempted: boolean;
  readonly imagingClaimAttempted: boolean;
  readonly noComplaintClaimAttempted: boolean;
  readonly clearNowAttempted: boolean;
  readonly observationRecord: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
  ...
  readonly injuryRecord: {
    readonly atTick: number; readonly mechanism: string; readonly hoursSinceInjury: number;
    readonly listedInjuries: number; readonly imagingReported: boolean;
    readonly sedated: boolean; readonly tertiarySurveyDocumented: boolean;
  } | null;
  readonly observation: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
    readonly mechanism: string; readonly hoursSinceInjury: number;
    readonly listedInjuries: number; readonly imagingReported: boolean;
    readonly sedated: boolean; readonly tertiarySurveyDocumented: boolean;
    readonly alertness: string;
  } | null;
...
export interface UnspokenDoubtSnapshot {
  readonly noticedStatedAtTick: number | null;
  readonly fallibilityStatedAtTick: number | null;
  readonly asymmetryStatedAtTick: number | null;
  readonly spokenAtTick: number | null;
  readonly teamIntentAtTick: number | null;
  readonly boundariesReviewedAtTick: number | null;
  readonly consentSide: string;
  readonly markedSide: string;
  readonly imageLabelSide: string;
  readonly raisedByAnyoneElse: boolean;
  readonly incisionMade: boolean;
  readonly knifeRequested: boolean;
  readonly teamResponded: boolean;
  readonly teamObserved: boolean;
  readonly waitForSeniorAttempted: boolean;
  readonly selfDoubtAttempted: boolean;
  readonly afterwardsAttempted: boolean;
  readonly quietAskAttempted: boolean;
  readonly observationRecord: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
  } | null;
  readonly checklistRecord: {
    readonly atTick: number; readonly consentSide: string; readonly markedSide: string;
    readonly imageLabelSide: string; readonly briefCompleted: boolean;
    readonly raisedByAnyoneElse: boolean; readonly incisionMade: boolean;
  } | null;
  readonly observation: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
    readonly consentSide: string; readonly markedSide: string;
    readonly imageLabelSide: string; readonly briefCompleted: boolean;
    readonly raisedByAnyoneElse: boolean; readonly incisionMade: boolean;
    readonly alertness: string;
  } | null;
...
export interface ThirdAttendanceSnapshot {
  ...
  readonly changeRecordedAtTick: number | null;
  readonly escalationAtTick: number | null;
  readonly assessmentIntentAtTick: number | null;
  readonly boundariesReviewedAtTick: number | null;
  readonly attendances: number;
  readonly daysSinceFirst: number;
  readonly imagingPerformed: boolean;
  readonly painLocalised: boolean;
  readonly colleagueSpoke: boolean;
  readonly teamResponded: boolean;
  readonly teamObserved: boolean;
  readonly seenTwiceAttempted: boolean;
  readonly settlingClaimAttempted: boolean;
  readonly anxiousClaimAttempted: boolean;
  readonly sameAdviceAttempted: boolean;
  readonly observationRecord: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
  ...
  readonly attendanceRecord: {
    readonly atTick: number; readonly attendances: number; readonly daysSinceFirst: number;
    readonly firstVisitFinding: string; readonly secondVisitFinding: string;
    readonly painLocalised: boolean; readonly worseOnMovement: boolean;
    readonly eatingToday: boolean; readonly imagingPerformed: boolean;
  } | null;
  readonly observation: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
    readonly attendances: number; readonly daysSinceFirst: number;
    readonly firstVisitFinding: string; readonly secondVisitFinding: string;
    readonly painLocalised: boolean; readonly worseOnMovement: boolean;
    readonly eatingToday: boolean; readonly imagingPerformed: boolean;
    readonly alertness: string;
...
export interface QuietChestSnapshot {
  ...
  readonly countRecordedAtTick: number | null;
  readonly escalationAtTick: number | null;
  readonly admissionIntentAtTick: number | null;
  readonly boundariesReviewedAtTick: number | null;
  readonly hoursSinceFall: number;
  readonly fracturedRibs: number;
  readonly pneumothoraxReported: boolean;
  readonly livesAlone: boolean;
  readonly effortObserved: boolean;
  readonly familyCalled: boolean;
  readonly teamResponded: boolean;
  readonly teamObserved: boolean;
  readonly normalNumbersAttempted: boolean;
  readonly filmClaimAttempted: boolean;
  readonly painReportAttempted: boolean;
  readonly dischargeAttempted: boolean;
  readonly observationRecord: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
  ...
  readonly chestRecord: {
    readonly atTick: number; readonly mechanism: string; readonly hoursSinceFall: number;
    readonly fracturedRibs: number; readonly pneumothoraxReported: boolean;
    readonly haemothoraxReported: boolean; readonly copd: boolean;
    readonly livesAlone: boolean; readonly effortObserved: boolean;
  } | null;
  readonly observation: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
    readonly mechanism: string; readonly hoursSinceFall: number;
    readonly fracturedRibs: number; readonly pneumothoraxReported: boolean;
    readonly haemothoraxReported: boolean; readonly copd: boolean;
    readonly livesAlone: boolean; readonly effortObserved: boolean;
    readonly alertness: string;
...
export interface TransientResponseSnapshot {
  readonly mechanismRecordedAtTick: number | null;
  readonly responseRecordedAtTick: number | null;
  readonly imagingLimitsRecordedAtTick: number | null;
  readonly escalationAtTick: number | null;
  readonly operativeIntentAtTick: number | null;
  readonly boundariesReviewedAtTick: number | null;
  readonly minutesSinceInjury: number;
  readonly bolusCount: number;
  readonly firstResponseHeldMinutes: number;
  readonly secondResponseHeldMinutes: number;
  readonly freeFluidReported: boolean;
  readonly fallen: boolean;
  readonly teamResponded: boolean;
  readonly teamObserved: boolean;
  readonly stabilityClaimAttempted: boolean;
  readonly scanFirstAttempted: boolean;
  readonly anotherLitreAttempted: boolean;
  readonly waitForBloodAttempted: boolean;
  readonly observationRecord: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
  } | null;
  readonly responseRecord: {
    readonly atTick: number; readonly mechanism: string; readonly minutesSinceInjury: number;
    readonly bolusCount: number; readonly firstResponseHeldMinutes: number;
    readonly secondResponseHeldMinutes: number; readonly freeFluidReported: boolean;
  } | null;
  readonly observation: {
    readonly atTick: number; readonly heartRateBpm: number; readonly systolicMmHg: number;
    readonly diastolicMmHg: number; readonly respiratoryRateBpm: number;
    readonly spo2Percent: number; readonly coreTemperatureC: number;
    readonly mechanism: string; readonly minutesSinceInjury: number;
    readonly bolusCount: number; readonly firstResponseHeldMinutes: number;
    readonly secondResponseHeldMinutes: number; readonly freeFluidReported: boolean;
    readonly alertness: string;
  } | null;
...
export interface RenalHypocalcemiaSnapshot {
  ...
  readonly mineralCareAtTick: number | null; readonly followUpAtTick: number | null;
  readonly rescueDueInSeconds: number | null; readonly continuingDueInSeconds: number | null;
  readonly rescueResponseObserved: boolean; readonly continuingResponseObserved: boolean; readonly recurrenceObserved: boolean;
  readonly adjustedReassuranceAttempted: boolean; readonly oralOnlyAttempted: boolean; readonly stoppedAfterReliefAttempted: boolean;
  readonly ionizedObservation: { readonly atTick: number; readonly ionizedCalciumMmolL: number } | null;
  readonly symptomObservation: { readonly atTick: number; readonly carpopedalSpasm: boolean; readonly perioralTingling: boolean } | null;
  readonly observation: {
    readonly atTick: number; readonly ionizedCalciumMmolL: number; readonly carpopedalSpasm: boolean;
    readonly perioralTingling: boolean; readonly alertness: string;
    readonly systolicMmHg: number; readonly diastolicMmHg: number; readonly meanArterialMmHg: number;
    readonly heartRateBpm: number; readonly respiratoryRateBpm: number; readonly spo2Percent: number; readonly coreTemperatureC: number;
  } | null;
...
export interface RenalHypernatremiaSnapshot {
  readonly supportActive: boolean;
  readonly volumeAtTick: number | null; readonly waterAtTick: number | null;
  readonly lossManagementAtTick: number | null; readonly waterAccessAtTick: number | null;
  readonly contextReviewedAtTick: number | null; readonly monitoringAtTick: number | null;
  readonly volumeDueInSeconds: number | null; readonly waterDueInSeconds: number | null;
  readonly combinedDueInSeconds: number | null;
  readonly circulationRestored: boolean; readonly volumeObserved: boolean;
  readonly waterResponseObserved: boolean; readonly combinedResponseObserved: boolean; readonly recurrenceObserved: boolean;
  readonly empiricDesmopressinAttempted: boolean; readonly normalizationAttempted: boolean;
  ...
  readonly fluidBalanceObservation: { readonly atTick: number; readonly urineOutputMlPerHour: number; readonly ongoingDiarrhea: boolean } | null;
  readonly observation: {
    readonly atTick: number; readonly sodiumMmolL: number; readonly changeFromBaselineMmolL: number;
    readonly urineOutputMlPerHour: number; readonly ongoingDiarrhea: boolean; readonly alertness: string;
    readonly systolicMmHg: number; readonly diastolicMmHg: number; readonly meanArterialMmHg: number;
    readonly heartRateBpm: number; readonly respiratoryRateBpm: number; readonly spo2Percent: number; readonly coreTemperatureC: number;
  } | null;
  readonly alertness: string; readonly choiceFeedback: string | null;
...
export interface RenalHypokalemiaSnapshot {
  readonly supportActive: boolean;
  readonly contextReviewedAtTick: number | null; readonly monitoringAtTick: number | null;
  readonly potassiumAtTick: number | null; readonly magnesiumAtTick: number | null;
  readonly lossManagementAtTick: number | null;
  readonly potassiumDueInSeconds: number | null; readonly magnesiumDueInSeconds: number | null;
  readonly responseDueInSeconds: number | null; readonly recurrenceDueInSeconds: number | null;
  readonly potassiumResponseObserved: boolean; readonly magnesiumResponseObserved: boolean;
  readonly responseObserved: boolean; readonly recurrenceObserved: boolean;
  readonly rapidPotassiumAttempted: boolean; readonly monitoringStopAttempted: boolean;
  readonly potassiumObservation: { readonly atTick: number; readonly potassiumMmolL: number } | null;
  readonly ecgObservation: { readonly atTick: number; readonly rhythm: 'hypokalemic-repolarization' | 'sinus' } | null;
  readonly observation: {
    readonly atTick: number; readonly potassiumMmolL: number; readonly magnesiumMmolL: number;
    readonly rhythm: 'hypokalemic-repolarization' | 'sinus';
    readonly systolicMmHg: number; readonly diastolicMmHg: number; readonly meanArterialMmHg: number;
...
export interface PerioperativeDiabetesSnapshot {
  ...
  readonly monitoringAtTick: number | null; readonly insulinAtTick: number | null;
  readonly earlyDueInSeconds: number | null; readonly responseDueInSeconds: number | null;
  readonly earlyResponseObserved: boolean; readonly responseObserved: boolean; readonly deteriorationObserved: boolean;
  readonly omitInsulinAttempted: boolean; readonly cgmOnlyAttempted: boolean; readonly clearanceAttempted: boolean;
  readonly glucoseObservation: { readonly atTick: number; readonly glucoseMgDl: number } | null;
  readonly observation: {
    readonly atTick: number; readonly glucoseMgDl: number; readonly ketonesMmolL: number;
    readonly systolicMmHg: number; readonly diastolicMmHg: number; readonly meanArterialMmHg: number;
    readonly heartRateBpm: number; readonly respiratoryRateBpm: number; readonly spo2Percent: number;
    readonly coreTemperatureC: number; readonly alertness: string;
  } | null;
...
export interface HypocalcemiaSnapshot {
  ...
  readonly calciumAtTick: number | null; readonly magnesiumAtTick: number | null; readonly continuingCareAtTick: number | null;
  readonly calciumDueInSeconds: number | null; readonly responseDueInSeconds: number | null;
  readonly calciumResponseObserved: boolean; readonly responseObserved: boolean;
  readonly urgentTreatmentDelayed: boolean; readonly recurrenceOccurred: boolean;
  readonly oralOnlyChosen: boolean; readonly waitForLabsChosen: boolean;
  readonly waitForMagnesiumChosen: boolean; readonly stopAfterReliefAttempted: boolean;
  readonly observation: {
    readonly atTick: number; readonly systolicMmHg: number; readonly diastolicMmHg: number; readonly meanArterialMmHg: number;
    readonly heartRateBpm: number; readonly respiratoryRateBpm: number; readonly spo2Percent: number;
    readonly coreTemperatureC: number; readonly adjustedCalciumMgDl: number; readonly symptoms: string;
  } | null;
  readonly symptoms: string; readonly choiceFeedback: string | null;
  readonly ended: 'handoff' | 'instructor-takeover' | null;
  readonly authoredStateTransitions: true; readonly doseModelAvailable: false; readonly durableRecoveryProven: false;
}

export interface HypercalcemiaSnapshot {
  readonly supportActive: boolean;
  readonly cardiorenalAssessedAtTick: number | null; readonly fluidsAtTick: number | null;
  readonly calcitoninAtTick: number | null; readonly antiresorptiveAtTick: number | null;
  readonly fluidDueInSeconds: number | null; readonly bridgeDueInSeconds: number | null;
  readonly fluidResponseObserved: boolean; readonly bridgeResponseObserved: boolean;
  readonly urgentTreatmentDelayed: boolean; readonly unrestrictedFluidsAttempted: boolean;
  readonly routineDiureticAttempted: boolean; readonly waitForCauseChosen: boolean;
  readonly observation: {
    readonly atTick: number; readonly systolicMmHg: number; readonly diastolicMmHg: number; readonly meanArterialMmHg: number;
    readonly heartRateBpm: number; readonly respiratoryRateBpm: number; readonly spo2Percent: number;
    readonly coreTemperatureC: number; readonly adjustedCalciumMgDl: number; readonly alertness: string; readonly fluidTolerance: string;
  } | null;
  readonly alertness: string; readonly choiceFeedback: string | null;
  readonly ended: 'handoff' | 'instructor-takeover' | null;
  readonly authoredStateTransitions: true; readonly doseModelAvailable: false; readonly durableRecoveryProven: false;
...
export interface EquipmentSnapshot {
  ...
  readonly resuscitation: {
    ...
    readonly obstetricsMaternalNeonatalHandoffAssessment?: {
      ...
      readonly reassessmentAtTick: number | null; readonly handoffAtTick: number | null;
      readonly authoredMaternalNeonatalHandoff: true;
      readonly authoredQualifiedPostresuscitationCourse: boolean;
      readonly maternalOrNewbornExaminedByLearner: false;
      readonly monitoringOrTestsInterpretedByLearner: false;
      readonly diagnosisMadeByLearner: false; readonly newbornResuscitationPerformedByLearner: false;
      readonly oxygenOrVentilationDeliveredByLearner: false; readonly airwayManagedByLearner: false;
      readonly compressionsAccessFluidBloodGlucoseOrDrugDeliveredByLearner: false;
      readonly maternalAnesthesiaOrSurgeryPerformedByLearner: false;
      readonly newbornCareOrTransportPerformedByLearner: false;
      readonly familyCounselingPerformedByLearner: false; readonly newbornStabilityProven: false;
      readonly maternalRecoveryProven: false; readonly placentalCauseDetermined: false;
      readonly safetyDispositionDetermined: false; readonly maternalOutcomePredicted: false;
      readonly newbornOutcomePredicted: false; readonly outcomePredicted: false;
    };
    ...
    readonly neonatologyApneaAssessment?: {
      ...
      readonly recognitionAtTick: number | null; readonly readinessAtTick: number | null;
      readonly reassessmentAtTick: number | null; readonly handoffAtTick: number | null;
      readonly authoredApneaAndHeartRatePattern: true;
      readonly authoredQualifiedEarlyResponse: boolean;
      readonly newbornExaminedOrScoredByLearner: false;
      readonly monitoringOrTestsInterpretedByLearner: false; readonly diagnosisMadeByLearner: false;
      readonly positioningDryingWarmingSuctionOrStimulationPerformedByLearner: false;
      readonly oxygenOrVentilationDeliveredByLearner: false; readonly airwayManagedByLearner: false;
      readonly ventilationCorrectiveStepsPerformedByLearner: false;
      readonly compressionsAccessFluidGlucoseOrDrugDeliveredByLearner: false;
      readonly feedingPerformedByLearner: false; readonly resuscitationPerformedByLearner: false;
      readonly transportOrProcedurePerformedByLearner: false; readonly durableBreathingProven: false;
      readonly stableTransitionProven: false; readonly neurologicSafetyProven: false;
      readonly causeDetermined: false; readonly safetyDispositionDetermined: false;
    ...
    readonly neonatologyIneffectiveVentilationAssessment?: {
      ...
      readonly recognitionAtTick: number | null; readonly readinessAtTick: number | null;
      readonly reassessmentAtTick: number | null; readonly handoffAtTick: number | null;
      readonly authoredIneffectiveVentilationPattern: true;
      readonly authoredQualifiedCorrectionResponse: boolean;
      readonly newbornExaminedOrScoredByLearner: false;
      readonly monitoringOrTestsInterpretedByLearner: false; readonly diagnosisMadeByLearner: false;
      readonly maskOrDeviceHandledByLearner: false;
      readonly positioningDryingWarmingSuctionOrStimulationPerformedByLearner: false;
      readonly pressureRatePeepOrOxygenSelectedByLearner: false;
      readonly oxygenOrVentilationDeliveredByLearner: false;
      readonly ventilationCorrectiveStepsPerformedByLearner: false;
      readonly airwayPlacedByLearner: false;
      readonly compressionsAccessFluidGlucoseOrDrugDeliveredByLearner: false;
      readonly feedingPerformedByLearner: false; readonly resuscitationPerformedByLearner: false;
      readonly transportOrProcedurePerformedByLearner: false; readonly durableBreathingProven: false;
      readonly stableTransitionProven: false; readonly airwayOrLungDiseaseExcluded: false;
      readonly neurologicSafetyProven: false; readonly causeDetermined: false;
    ...
    readonly neonatologyBradycardiaAssessment?: {
      ...
      readonly recognitionAtTick: number | null; readonly readinessAtTick: number | null;
      readonly reassessmentAtTick: number | null; readonly handoffAtTick: number | null;
      readonly authoredSevereBradycardiaAfterAdequateVentilation: true;
      readonly authoredQualifiedCompressionResponse: boolean;
      readonly newbornExaminedOrScoredByLearner: false;
      readonly monitoringOrTestsInterpretedByLearner: false; readonly diagnosisMadeByLearner: false;
      readonly maskOrDeviceHandledByLearner: false; readonly pressureRatePeepOrOxygenSelectedByLearner: false;
      readonly oxygenOrVentilationDeliveredByLearner: false; readonly airwayPlacedOrVerifiedByLearner: false;
      readonly compressionPerformedByLearner: false;
      readonly accessFluidBloodGlucoseOrDrugDeliveredByLearner: false;
      readonly feedingPerformedByLearner: false; readonly resuscitationPerformedByLearner: false;
      readonly transportOrProcedurePerformedByLearner: false; readonly durableCirculationProven: false;
      readonly durableBreathingProven: false; readonly stableTransitionProven: false;
      readonly neurologicSafetyProven: false; readonly causeDetermined: false;
      readonly treatmentEffectProven: false; readonly safetyDispositionDetermined: false;
      readonly newbornOutcomePredicted: false; readonly parentOutcomePredicted: false;
      readonly outcomePredicted: false;
    ...
    readonly neonatologyNicuHandoffAssessment?: {
      ...
      readonly reassessmentAtTick: number | null; readonly handoffAtTick: number | null;
      readonly authoredPostresuscitationTransfer: true;
      readonly authoredReceiverCheckBackAndTenMinuteArrivalReport: boolean;
      readonly historyTakenByLearner: false; readonly newbornExaminedOrScoredByLearner: false;
      readonly recordOrMonitoringObtainedOrInterpretedByLearner: false;
      readonly diagnosisMadeByLearner: false;
      readonly warmingCoolingCpapOxygenOrDeviceOperatedByLearner: false;
      readonly respiratorySupportVentilationOrAirwayManagedByLearner: false;
      readonly accessGlucoseFluidBloodOrDrugDeliveredByLearner: false;
      readonly feedingPerformedByLearner: false; readonly resuscitationPerformedByLearner: false;
      readonly transportPositioningOrSupportPerformedByLearner: false;
      readonly communicationDocumentationCounselingOrCheckBackPerformedByLearner: false;
      readonly procedurePerformedByLearner: false; readonly sharedUnderstandingProven: false;
      readonly treatmentEffectProven: false; readonly diagnosisOrCauseDetermined: false;
      readonly durableStabilityProven: false; readonly feedingSafetyProven: false;
      readonly safetyDispositionDetermined: false; readonly newbornOutcomePredicted: false;
      readonly parentOutcomePredicted: false; readonly outcomePredicted: false;
    };
    ...
    readonly endocrineDkaResolutionAssessment?: {
      ...
      readonly recognitionAtTick: number | null; readonly readinessAtTick: number | null;
      readonly reassessmentAtTick: number | null; readonly handoffAtTick: number | null;
      readonly authoredLateTreatmentUnresolvedDka: true;
      readonly authoredQualifiedResolutionAndBasalOverlapReport: boolean;
      readonly biochemicalResolutionReported: boolean;
      readonly historyTakenOrPatientExaminedByLearner: false;
      readonly glucoseKetoneElectrolyteGasOrTestObtainedCalculatedOrInterpretedByLearner: false;
      readonly fluidElectrolyteDextroseInsulinBicarbonateOrDrugSelectedOrDeliveredByLearner: false;
      readonly doseConcentrationRateRouteOrAccessSelectedByLearner: false;
      readonly infusionOperatedByLearner: false; readonly nutritionPrescribedOrDeliveredByLearner: false;
      readonly medicationOrTransitionPerformedByLearner: false;
      readonly precipitantTreatedEducationAccessOrFollowUpArrangedByLearner: false;
      readonly diagnosisMadeByLearner: false; readonly procedurePerformedByLearner: false;
      readonly universalDoseOrTreatmentEffectProven: false; readonly independentInsulinSafetyProven: false;
      readonly durableGlucoseOrPotassiumStabilityProven: false; readonly precipitantResolved: false;
