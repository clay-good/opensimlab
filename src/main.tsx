...
const HYDRATABLE = new Set(['', '/about', '/for-educators', '/curriculum', '/validation', '/governance', '/limitations', '/privacy', '/cardiology', '/respiratory-medicine', '/pediatrics', '/oncology', '/critical-care']);
