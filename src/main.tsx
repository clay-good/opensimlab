...
const HYDRATABLE = new Set(['', '/about', '/for-educators', '/curriculum', '/validation', '/governance', '/limitations', '/privacy', '/emergency-medicine', '/cardiology', '/oncology', '/critical-care']);
