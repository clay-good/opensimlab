  ...
  it('Scenario: Board coverage matches the content', () => {
    ...
    const covered = uncoveredDomains(items, [{
      ...
      scope: ['adult-general-anaesthesia', 'emergency-medicine', 'critical-care',
        'cardiology', 'respiratory-medicine', 'pediatrics', 'neurology', 'toxicology', 'obstetrics', 'neonatology', 'endocrine-metabolic', 'renal-electrolyte', 'infectious-disease', 'medical-surgical-nursing', 'oncology', 'surgery-trauma', 'pharmacology',
        'practice-variation'],
