...
describe('Requirement: Every Audited Example Is Offered', () => {
  ...
  it('offers every anesthesia example and nothing else in the module', () => {
    ...
    // offers all thirty-nine, and they do not all work the same way: all but one are
    ...
    // exist. Every lab in the module now offers one.
    ...
    expect(offered.slice().sort()).toEqual([
      'arterial-pressure-transducer-artifact', 'aspiration-risk-recognition',
      'awareness-under-paralysis', 'blood-bank-handoff',
      'bronchospasm',
      'capnography-sampling-line-obstruction',
      'circle-system-rebreathing',
      'delayed-emergence-differential', 'difficult-airway-supraglottic-rescue',
      'dilutional-coagulopathy',
      'early-malignant-hyperthermia-during-volatile-anesthesia',
      'emergence-with-residual-blockade', 'extubation-readiness',
      'high-spinal-after-epidural-top-up', 'hypotension-after-induction',
      ...
      'perioperative-anaphylaxis-after-antibiotic', 'perioperative-hyperglycemia',
      'persistent-vf-cardiac-arrest',
      'pneumothorax-under-positive-pressure', 'post-extubation-obstruction',
      'postoperative-handoff',
      'preeclampsia-urgent-delivery',
      'quantitative-neuromuscular-reversal', 'rapid-desaturation',
      'rapid-sequence-induction', 'repeated-laryngoscopy-harm',
      'routine-geriatric-induction', 'routine-induction',
      'routine-inhalational-maintenance',
      'routine-pediatric-inhalational-induction', 'routine-pediatric-iv-induction',
      'unexpected-intraoperative-hemorrhage',
      'venous-air-embolism-during-line-removal',
    ]);
  });
