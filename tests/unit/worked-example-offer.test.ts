...
describe('Requirement: Every Audited Example Is Offered', () => {
  ...
  it('offers every anesthesia example and nothing else in the module', () => {
    ...
    // offers thirty-two, and they do not all work the same way: all but one are
    ...
    // exist. The remaining seven labs offer nothing.
    ...
    expect(offered.slice().sort()).toEqual([
      'aspiration-risk-recognition', 'awareness-under-paralysis', 'blood-bank-handoff',
      'bronchospasm',
