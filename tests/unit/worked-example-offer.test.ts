...
describe('Requirement: Every Audited Example Is Offered', () => {
  ...
  it('offers every anesthesia example and nothing else in the module', () => {
    ...
    // offers sixteen, and they do not all work the same way: all but one are
    ...
    // exist. The remaining twenty-three labs offer nothing.
    ...
    expect(offered.slice().sort()).toEqual([
      'awareness-under-paralysis', 'bronchospasm', 'dilutional-coagulopathy',
