...
describe('Obstetrics eclampsia experience', () => {
  ...
  it('requires exact identity and exposes one calm action without drug, airway, or delivery controls', () => {
    ...
    expect(crisisResponseAvailabilityWithTrays({ ...SCENARIO, metadata: { ...SCENARIO.metadata, id: 'lookalike' } }).hasObstetricsEclampsiaResponse).toBe(false);
    ...
    expect(crisisResponseAvailabilityWithTrays(missingBoundary).hasObstetricsEclampsiaResponse).toBe(false);
