...
describe('Requirement: crisis epinephrine is explicit, bounded, and does not name a diagnosis', () => {
  ...
  it('shows every matching rescue control after a manual injection into an ordinary scenario', () => {
    expect(crisisResponseAvailability(ROUTINE_INDUCTION, [
      ...
      hasApeSupportResponse: false,
      hasBronchiectasisMucusPluggingResponse: false,
      ...
      hasHighFlowOxygenEscalationResponse: false,
      hasOxygenDeviceFailureResponse: false,
      hasAcuteTracheostomyObstructionResponse: false,
      hasPediatricRespiratoryDistressResponse: false,
      hasBronchiolitisResponse: false,
      hasCroupResponse: false,
      hasPediatricStatusAsthmaticusResponse: false,
      hasPediatricSepsisResponse: false,
      hasPediatricSepticShockResponse: false,
      hasPediatricDehydrationResponse: false,
      hasPediatricDiabeticKetoacidosisResponse: false,
      hasPediatricHypoglycemicSeizureResponse: false,
      hasPediatricFebrileSeizureResponse: false,
      ...
      hasNeurologyCerebellarIchResponse: false,
      hasNeurologyAsahDeteriorationResponse: false,
      ...
      hasNeurologyRaisedIcpResponse: false,
      hasNeurologyHerniationResponse: false,
      hasNeurologyMsccResponse: false,
      hasNeurologyDeliriumResponse: false,
      hasNeurologyAutonomicDysreflexiaResponse: false,
      hasToxicologyMethemoglobinemiaResponse: false,
      hasToxicologyCarbonMonoxideResponse: false,
      hasToxicologyAcetaminophenResponse: false,
      hasToxicologySalicylateResponse: false,
      hasToxicologyTricyclicResponse: false,
      ...
      hasToxicologyAnticholinergicResponse: false,
      hasToxicologySerotoninResponse: false,
      hasToxicologySympathomimeticResponse: false,
      hasToxicologyMethanolResponse: false,
      ...
      hasObstetricsConcealedAbruptionResponse: false,
      hasObstetricsPostpartumPreeclampsiaResponse: false,
      hasObstetricsEclampsiaResponse: false,
      ...
      hasObstetricsUterineRuptureResponse: false,
      hasObstetricsMagnesiumToxicityResponse: false,
      hasObstetricsHighNeuraxialResponse: false,
      hasObstetricsFailedIntubationResponse: false,
      hasObstetricsMaternalNeonatalHandoffResponse: false,
      hasObstetricsOxytocinTachysystoleResponse: false,
      hasNeonatologyTermTransitionResponse: false,
      hasNeonatologyApneaResponse: false,
      hasNeonatologyIneffectiveVentilationResponse: false,
      hasNeonatologyBradycardiaResponse: false,
      hasNeonatologyMeconiumTransitionResponse: false,
      hasNeonatologyPretermRespiratoryDistressResponse: false,
      hasNeonatologyHypoglycemiaResponse: false,
      hasNeonatologySepsisResponse: false,
      ...
      hasEndocrineHhsResponse: false,
      hasSevereHypoglycemiaResponse: false,
      hasAdrenalCrisisResponse: false,
      hasThyroidStormResponse: false,
      ...
      hasAvpDeficiencyResponse: false,
      hasRefeedingResponse: false,
      hasPerioperativeDiabetesResponse: false,
      hasRenalHyperkalemiaResponse: false,
      hasRenalHypokalemiaResponse: false,
      hasRenalHyponatremiaResponse: false,
      hasRenalHypernatremiaResponse: false,
      hasRenalHypocalcemiaResponse: false,
      hasRenalHypermagnesemiaResponse: false,
      hasMeningococcalSepsisResponse: false,
      hasObstructedKidneyResponse: false,
      hasFebrileNeutropeniaResponse: false,
      hasNecrotizingInfectionResponse: false,
      hasEndocarditisHeartFailureResponse: false,
      hasSeverePneumoniaResponse: false,
      hasToxicShockResponse: false,
      hasPossibleSepsisResponse: false,
      hasSepticShockLabelResponse: false,
      hasMeningitisImagingResponse: false,
      hasLostContingencyResponse: false,
      hasLowScoreResponse: false,
      hasCountedRateResponse: false,
      hasOxygenTargetScaleResponse: false,
      hasPairedReadingResponse: false,
      hasAfferentLimbResponse: false,
      hasQuietPatientResponse: false,
      hasProxyScaleResponse: false,
      hasPulmonaryEmbolismResponse: false,
      hasStemiResponse: false,
      hasUnstableNarrowTachycardiaResponse: false,
      hasUnstableBradycardiaResponse: false,
      hasStatusEpilepticusResponse: false,
      hasAcuteIschemicStrokeResponse: false,
      hasIntracranialHemorrhageResponse: false,
      hasDiabeticKetoacidosisResponse: false,
      hasHyperkalemiaResponse: false,
      hasSevereHyponatremiaResponse: false,
      hasOpioidToxicityResponse: false,
      hasHeatStrokeResponse: false,
      hasTraumaPrimarySurveyResponse: false,
      hasAcuteAorticSyndromeResponse: false,
      hasArdsLungProtectiveResponse: false,
      hasEscalatingHypoxemiaResponse: false,
      ...
      hasSpontaneousBreathingTrialResponse: false,
      hasPostIntubationHypotensionResponse: false,
      hasCardiogenicShockResponse: false,
      hasMixedShockResponse: false,
      hasRightVentricularFailureResponse: false,
      hasRightVentricularInfarctionResponse: false,
      hasMassivePulmonaryEmbolismResponse: false,
      hasUpperGiHemorrhageResponse: false,
      hasCriticalCareStatusEpilepticusResponse: false,
      hasPostArrestTemperatureResponse: false,
      hasPostInfarctionShockResponse: false,
      hasStableNarrowTachycardiaResponse: false,
      hasStableWideTachycardiaResponse: false,
      hasSymptomaticBradycardiaResponse: false,
      ...
      hasPacemakerCaptureFailureResponse: false,
      hasTranscutaneousPacingCaptureResponse: false,
      hasAcuteSevereAsthmaResponse: false,
      hasCopdTransitionResponse: false,
      hasCapHypoxemiaResponse: false,
      hasPostPeDyspneaResponse: false,
      hasPostTensionPneumothoraxResponse: false,
      hasLargePleuralEffusionResponse: false,
      hasPericardialTamponadeResponse: false,
      hasIntracranialHypertensionResponse: false,
      hasAkiFluidOverloadResponse: false,
      hasSevereAcidemiaResponse: false,
      hasIcuHiddenDeteriorationHandoffResponse: false,
      hasVentilatorCircuitDisconnectionResponse: false,
      hasDelayedImmuneEventResponse: false,
      hasIncidentalClotResponse: false,
      ...
      hasTrialRuleResponse: false,
      hasSilentInteractionResponse: false,
      hasEasyLabelResponse: false,
      hasNegativeScanResponse: false,
      hasRisingRequirementResponse: false,
      hasUnfinishedSurveyResponse: false,
      hasTransientResponseResponse: false,
      hasQuietChestResponse: false,
      hasUnownedDelayResponse: false,
      hasThirdAttendanceResponse: false,
      hasDeferredStepResponse: false,
      hasKnownLabelResponse: false,
      hasUnspokenDoubtResponse: false,
      hasRareEarlyMyocarditisResponse: false,
      hasPrognosisQuestionResponse: false,
      hasDelayedVasopressorDeliveryResponse: false,
      hasPulseOximeterArtifactResponse: false,
      hasEndotrachealTubeMigrationResponse: false,
      hasSepticShockResuscitationResponse: false,
      hasStableChestPainResponse: false,
      hasNstemiRiskResponse: false,
      hasClinicStemiResponse: false,
      hasHeartFailureResponse: false,
      hasAfRvrResponse: false,
