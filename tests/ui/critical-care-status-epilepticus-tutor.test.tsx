...
describe('Refractory status epilepticus chain and boundaries', () => {
  ...
  it('fails closed on the timeline target rather than the scenario id', () => {
    expect(crisisResponseAvailabilityWithTrays(SCENARIO).hasCriticalCareStatusEpilepticusResponse).toBe(true);
...
describe('Refractory status epilepticus tutor and worked example', () => {
  ...
  it('leaves the controls visible but inert while the example runs', () => {
    ...
    const watching = markup(EMPTY, { guidance: 'guided', demonstratingLessonId: 'CriticalCareStatusEpilepticus' });
