...
describe('Neonatal bradycardia tutor and worked example', () => {
  ...
  it('refuses the post-hoc reading at the handoff beat', () => {
    const html = markup(observed, { guidance: 'guided' });
  ...
  it('leaves the controls visible but inert while the example runs', () => {
    ...
    const watching = markup(start, { guidance: 'guided', demonstratingLessonId: 'NeonatalBradycardia' });
