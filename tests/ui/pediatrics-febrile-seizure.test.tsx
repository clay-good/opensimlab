...
describe('Pediatric febrile-seizure experience', () => {
  ...
  it('fails closed on the timeline target rather than the scenario id', () => {
    expect(crisisResponseAvailabilityWithTrays(SCENARIO).hasPediatricFebrileSeizureResponse).toBe(true);
...
describe('Pediatric febrile-seizure tutor and worked example', () => {
  ...
  it('leaves the controls visible but inert while the example runs', () => {
    ...
    const watching = markup(EMPTY, { guidance: 'guided', demonstratingLessonId: 'PediatricFebrileSeizure' });
