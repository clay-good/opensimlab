...
describe('Hypertensive emergency experience', () => {
  ...
  it('fails closed on the timeline target rather than the scenario id', () => {
    expect(crisisResponseAvailabilityWithTrays(SCENARIO).hasHypertensiveEmergencyResponse).toBe(true);
...
describe('Hypertensive emergency tutor and worked example', () => {
  ...
  it('reads the learner’s own recorded steps when guidance is on', () => {
    ...
    const organ = markup(MEASURED, { guidance: 'guided' });
  ...
  it('follows whichever middle lane the learner left open', () => {
    ...
    expect(markup(REDUCTION, { guidance: 'guided' }))
  ...
  it('leaves the controls visible but inert while the example runs', () => {
    ...
    const watching = markup(EMPTY, { guidance: 'guided', demonstratingLessonId: 'HypertensiveEmergency' });
