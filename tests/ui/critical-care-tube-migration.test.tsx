...
describe('Post-repositioning tube migration experience', () => {
  ...
  it('fails closed on the timeline target rather than the scenario id', () => {
    expect(crisisResponseAvailabilityWithTrays(SCENARIO).hasEndotrachealTubeMigrationResponse).toBe(true);
...
describe('Post-repositioning tube migration tutor and worked example', () => {
  ...
  it('reads the learner’s own recorded steps when guidance is on', () => {
    ...
    const support = markup(RECOGNIZED, { guidance: 'guided' });
  ...
  it('refuses to make 22 cm a rule', () => {
    expect(markup(POSITION, { guidance: 'guided' }))
