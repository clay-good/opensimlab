...
describe('Respiratory post-PE dyspnea experience', () => {
  ...
  it('fails closed and never offers a test, a diagnosis, or a drug change', () => {
    expect(crisisResponseAvailabilityWithTrays(SCENARIO).hasPostPeDyspneaResponse).toBe(true);
...
describe('Post-PE dyspnea tutor and worked example', () => {
  ...
  it('leaves the controls visible but inert while the example runs', () => {
    ...
    const watching = markup(EMPTY, { guidance: 'guided', demonstratingLessonId: 'PostPeDyspnea' });
