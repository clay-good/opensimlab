...
describe('Stable wide-complex tachycardia experience', () => {
  ...
  it('fails closed on the timeline target rather than the scenario id', () => {
    expect(crisisResponseAvailabilityWithTrays(SCENARIO).hasStableWideTachycardiaResponse).toBe(true);
...
describe('Stable wide-tachycardia tutor and worked example', () => {
  ...
  it('declines to litigate morphology criteria', () => {
    const html = markup(STABILITY, { guidance: 'guided' });
  ...
  it('leaves the controls visible but inert while the example runs', () => {
    ...
    const watching = markup(EMPTY, { guidance: 'guided', demonstratingLessonId: 'StableWideTachycardia' });
