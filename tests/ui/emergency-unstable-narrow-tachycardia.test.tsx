...
describe('Emergency unstable narrow-complex tachycardia experience', () => {
  ...
  it('fails closed on the timeline target rather than the scenario id', () => {
    expect(crisisResponseAvailabilityWithTrays(SCENARIO).hasUnstableNarrowTachycardiaResponse).toBe(true);
...
describe('Emergency unstable narrow-complex tachycardia tutor and worked example', () => {
  ...
  it('reads the learner’s own recorded steps when guidance is on', () => {
    ...
    const prepare = markup(REVIEWED, { guidance: 'guided' });
  ...
  it('treats the sedation clause honestly', () => {
    expect(markup(PREPARED, { guidance: 'guided' }))
  ...
  it('leaves the controls visible but inert while the example runs', () => {
    const watching = markup(EMPTY, { guidance: 'guided', demonstratingLessonId: 'UnstableNarrowTachycardia' });
