...
- [ ] Wave C: complete 17 cardiology and 15 respiratory-medicine scenarios. Cardiology is live with
  ...
  medicine is live with 3 of 15 scenarios: acute severe asthma reassessment after documented initial
  therapy, COPD exacerbation recovery-versus-readiness transition reassessment, and hypoxemic
  community-acquired pneumonia reassessment with bounded severity, escalation, treatment ownership,
  and active-care handoff.
