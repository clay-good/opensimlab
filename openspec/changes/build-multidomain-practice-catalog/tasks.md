...
- [ ] Wave B: complete 25 emergency-medicine and 24 critical-care scenarios.
  ...
  Critical Care is available with 1 of 24 scenarios. ARDS lung-protective ventilation reuses the
  shared deterministic session, monitor, transcript, action, and debrief frame and is completion-
  audited, prerendered, available offline, and explicitly bounded. The remaining 23 titles stay
