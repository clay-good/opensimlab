...
- [ ] Wave B: complete 25 emergency-medicine and 24 critical-care scenarios.
  ...
  Critical Care is available with 5 of 24 scenarios. ARDS lung-protective ventilation, escalating
  hypoxemia, ventilator dyssynchrony, auto-PEEP, and mucus plugging reuse the shared deterministic
  session, monitor, transcript, action, and debrief frame and are completion-audited, prerendered,
  available offline, and explicitly bounded. The remaining 19 titles stay descriptive scope until
