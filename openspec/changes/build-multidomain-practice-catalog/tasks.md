...
- [ ] Wave B: complete 25 emergency-medicine and 24 critical-care scenarios.
  Emergency Medicine is available with 14 of 25 scenarios. These first 14 — undifferentiated,
  septic, hemorrhagic,
  ...
  tachycardia, unstable bradycardia, and persistent VF arrest reuse the shared deterministic session,
  monitor, transcript, action, and debrief frame; all 14 are completion-audited, prerendered,
  available offline, and explicitly bounded. The remaining 11
