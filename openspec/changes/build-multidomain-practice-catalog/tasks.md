...
- [ ] Wave B: complete 25 emergency-medicine and 24 critical-care scenarios.
  Emergency Medicine is available with 21 of 25 scenarios. These first 21 — undifferentiated,
  septic, hemorrhagic,
  ...
  with ECG change, and severe hyponatremia with seizure reuse the shared deterministic session,
  monitor, transcript, action, and debrief frame; all 21 are completion-audited, prerendered,
  available offline, and explicitly bounded. The remaining 4 titles are scope only.
