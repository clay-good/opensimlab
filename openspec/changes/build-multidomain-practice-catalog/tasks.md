...
- [ ] Wave B: complete 25 emergency-medicine and 24 critical-care scenarios.
  ...
  Critical Care is available with 6 of 24 scenarios. ARDS lung-protective ventilation, escalating
  hypoxemia, ventilator dyssynchrony, auto-PEEP, mucus plugging, and unplanned extubation reuse the
  shared deterministic session, monitor, transcript, action, and debrief frame and are completion-
  audited, prerendered, available offline, and explicitly bounded. The remaining 18 titles stay
  descriptive scope until their full contracts pass.
