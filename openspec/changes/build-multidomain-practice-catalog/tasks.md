...
- [ ] Wave B: complete 25 emergency-medicine and 24 critical-care scenarios.
  Emergency Medicine is available with 22 of 25 scenarios. These first 22 — undifferentiated,
  septic, hemorrhagic,
  ...
  with ECG change, severe hyponatremia with seizure, and opioid toxicity reuse the shared
  deterministic session, monitor, transcript, action, and debrief frame; all 22 are completion-
  audited, prerendered, available offline, and explicitly bounded. The remaining 3 titles are scope only.
