...
- [ ] Wave B: complete 25 emergency-medicine and 24 critical-care scenarios.
  Emergency Medicine is available with 7 of 25 scenarios: undifferentiated, septic, hemorrhagic,
  tension-pneumothorax, cardiac-tamponade, community anaphylaxis, and adult asthma reuse the shared
  deterministic session, monitor, transcript, action, and debrief frame; all seven are
  completion-audited, prerendered, available offline, and explicitly bounded. The remaining 18
