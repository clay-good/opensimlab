...
- [ ] Wave B: complete 25 emergency-medicine and 24 critical-care scenarios.
  ...
  Critical Care is available with 16 of 24 scenarios. ARDS lung-protective ventilation, escalating
  ...
  epilepticus, post-arrest temperature control, and intracranial hypertension reuse the shared deterministic
  session, monitor, transcript, action, and debrief frame and are completion-audited, prerendered,
  available offline, and explicitly bounded. The remaining 8 titles stay descriptive scope until
