...
- [ ] Wave B: complete 25 emergency-medicine and 24 critical-care scenarios.
  ...
  Critical Care is available with 21 of 24 scenarios. ARDS lung-protective ventilation, escalating
  ...
  circuit disconnection, and delayed vasopressor delivery reuse the shared deterministic
  session, monitor, transcript, action, and debrief frame and are completion-audited, prerendered,
  available offline, and explicitly bounded. The remaining 3 titles stay descriptive scope until
