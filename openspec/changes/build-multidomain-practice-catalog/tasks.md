...
- [ ] Wave C: complete 17 cardiology and 15 respiratory-medicine scenarios. Cardiology is live with
  5 of 17 scenarios: stable chest-pain evaluation, STEMI recognition and first actions, NSTEMI risk
  reassessment, acute decompensated heart failure, and atrial fibrillation with rapid response. Respiratory
