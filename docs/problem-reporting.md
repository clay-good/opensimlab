...
catalog versions, canonical URLs, bounded text, control/bidirectional characters, and Turnstile's
...
submissions all return the same `202`. Add a Cloudflare WAF rate limit on the exact POST route before
